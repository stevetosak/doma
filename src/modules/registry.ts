...
/**
 * Every registered module. Empty today — chores (M5) and shopping (M6)
 * each add one import line here when they land. "Adding a module = a new
 * folder + one import line" (§5.2).
 */
